...
#define DECLARE_BUILTIN_FUNCTION_1(f,p) DECLARE_BUILTIN_FUNCTION(f,p,1)
#define DECLARE_BUILTIN_FUNCTION_2(f,p) DECLARE_BUILTIN_FUNCTION(f,p,2)
#define DECLARE_BUILTIN_FUNCTION_3(f,p) DECLARE_BUILTIN_FUNCTION(f,p,3)
#endif

DECLARE_BUILTIN_FUNCTION_2(set_prolog_flag,PACK_COMPOUND_BUILTIN(set_prolog_flag,2))
DECLARE_BUILTIN_FUNCTION_2(char_conversion,PACK_COMPOUND_BUILTIN(char_conversion,2))
DECLARE_BUILTIN_FUNCTION_2(current_char_conversion,PACK_COMPOUND_BUILTIN(current_char_conversion,2))
DECLARE_BUILTIN_FUNCTION_3(op,PACK_COMPOUND_EMBED_2(3,'o','p'))
DECLARE_BUILTIN_FUNCTION_3(current_op,PACK_COMPOUND_BUILTIN(current_op,3))
DECLARE_BUILTIN_FUNCTION_1(asserta,PACK_COMPOUND_BUILTIN(asserta,1))
DECLARE_BUILTIN_FUNCTION_1(assertz,PACK_COMPOUND_BUILTIN(assertz,1))
