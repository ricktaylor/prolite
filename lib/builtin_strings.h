...
DECLARE_BUILTIN_STRING(writeq)
DECLARE_BUILTIN_STRING(asserta)
DECLARE_BUILTIN_STRING(assertz)
DECLARE_BUILTIN_STRING(ceiling)
DECLARE_BUILTIN_STRING(dynamic)
DECLARE_BUILTIN_STRING(include)
DECLARE_BUILTIN_STRING(integer)
DECLARE_BUILTIN_STRING(missing)
DECLARE_BUILTIN_STRING(unknown)
DECLARE_BUILTIN_STRING(warning)
DECLARE_BUILTIN_STRING(callable)
DECLARE_BUILTIN_STRING(compound)
DECLARE_BUILTIN_STRING(operator)
DECLARE_BUILTIN_STRING(put_char)
DECLARE_BUILTIN_STRING(put_code)
DECLARE_BUILTIN_STRING(truncate)
...
DECLARE_BUILTIN_STRING(flag_value)
DECLARE_BUILTIN_STRING(write_term)
DECLARE_BUILTIN_STRING(back_quotes)
DECLARE_BUILTIN_STRING(max_integer)
DECLARE_BUILTIN_STRING(min_integer)
DECLARE_BUILTIN_STRING(prolog_flag)
DECLARE_BUILTIN_STRING(source_sink)
...
DECLARE_BUILTIN_STRING(double_quotes)
...
DECLARE_BUILTIN_STRING(write_canonical)
...
DECLARE_BUILTIN_STRING(float_integer_part)
...
DECLARE_BUILTIN_STRING(float_fractional_part)
