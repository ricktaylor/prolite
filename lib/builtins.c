...
#define BUILTIN_THUNK(f,n) \
	void builtin_##f(context_t* context, const void* gosub, size_t argc, const term_t* argv[]); \
	PROLITE_EXPORT void prolite_builtin_##f(context_t* context, const void* gosub) { \
...
void builtin_call(context_t* context, const void* gosub, size_t argc, const term_t* argv[]) {  }
void builtin_callN(context_t* context, const void* gosub, size_t argc, const term_t* argv[]) {  }
void builtin_callable(context_t* context, const void* gosub, size_t argc, const term_t* argv[]) {  }
void builtin_ground(context_t* context, const void* gosub, size_t argc, const term_t* argv[]) {  }
void builtin_term_compare(context_t* context, const void* gosub, size_t argc, const term_t* argv[]) {  }
